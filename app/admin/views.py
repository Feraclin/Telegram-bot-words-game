...
from app.admin.schemes import AdminSchema, AdminResponseScheme
...
class AdminLoginView(View):
    ...
    async def post(self):
        ...
        return json_response(data=AdminResponseScheme().dump(admin))
...
class AdminCurrentView(AuthRequiredMixin, View):
    ...
    async def get(self):
        ...
        return json_response(data=AdminResponseScheme().dump(self.request.admin))
