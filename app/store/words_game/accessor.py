...
class WGAccessor:
    ...
    get_city_by_first_letter - получение города по первой букве. Если не указана буква, выбирается случайная. Если не указано количество городов, выбирается все города, начинающиеся на указанную букву.
